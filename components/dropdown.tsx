...
function DropdownButton({ children }: { children: ReactNode }) {
  return (
    <RadixDropdownMenu.Trigger className="cursor-default select-none rounded px-2 text-xl hover:bg-gray-200/50 focus-visible:outline-none data-[state=open]:bg-gray-200/75">
      {children}
...
function DropdownMenuItem({
  ...
  return (
    <RadixDropdownMenu.Item
      ...
      className="max-w-xs select-none rounded px-2 py-1.5 text-gray-700 data-[highlighted]:bg-sky-400 data-[highlighted]:text-white data-[highlighted]:focus:outline-none sm:max-w-sm"
      asChild
    >
